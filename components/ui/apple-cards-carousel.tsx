  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          className="flex w-90% overflow-x-scroll overscroll-x-auto py-7 md:py-20 scroll-smooth [scrollbar-width:none]"
          ref={carouselRef}
  ...
  return (
    <>
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="max-w-5xl mx-auto bg-white dark:bg-black h-fit  z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button
              ...
              <motion.p
                ...
                className="text-2xl md:text-4xl font-semibold text-neutral-200 mt-4 dark:text-grey-200"
              >
                {card.title}
              </motion.p>
              <motion.a
                ...
                className="text-xl pt-6 font-medium text-black dark:text-white"
              >
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-black h-62 w-56 md:h-[37rem] md:w-96 overflow-hidden ring-2 ring-white/10 items-start justify-start relative z-10
        "
      >
